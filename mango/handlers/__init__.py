...
class BaseHandler(web.RequestHandler):
    ...
    def set_default_headers(self):
        ...
        '''
        self.set_header("Access-Control-Allow-Origin", self.settings.get('domain', 'spartanapproach.com'))
...
class LoginHandler(BaseHandler):
    ...
    def get(self):
        ...
        if validate_uuid4(uuid):
            ...
            self.set_header('Access-Control-Allow-Origin','spartanapproach.com')
