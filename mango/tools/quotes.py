...
_john_carmack_quotes = {
    ...
    1:"There are hacks in all current graphic cards to check if you're " \
        "playing early Quake-engine games. 'There are archeological " \
        "reasons why PC drivers have the stuff that they do.'",
    ...
    5:"The speed of light sucks.",
    6:"I'm good? Seriously?",
