...
class AccountMap(object):
    ...
    def __init__(
        ...
        self.map.registers['phones_total'].assign(struct.get('phones_total', ''))
        self.map.registers['emails'].assign(struct.get('emails', ''))
        self.map.registers['emails_total'].assign(struct.get('emails_total', ''))
        self.map.registers['history'].assign(struct.get('history', ''))
        self.map.registers['history_total'].assign(struct.get('history_total', ''))
        self.map.registers['layouts'].assign(struct.get('layouts', ''))
        self.map.registers['layouts_total'].assign(struct.get('layouts_total', ''))
        ...
        self.map.registers['orgs_total'].assign(struct.get('orgs_total', ''))
        self.map.registers['teams'].assign(struct.get('teams', ''))
        self.map.registers['teams_total'].assign(struct.get('teams_total', ''))
    ...
    def to_json(self):
        ...
        struct = {
            ...
            "phones_total": event.registers['phones_total'].value,
            "emails": event.registers['emails'].value,
            "emails_total": event.registers['emails_total'].value,
            "history": event.registers['history'].value,
            "history_total": event.registers['history_total'].value,
            "layouts": event.registers['layouts'].value,
            "layouts_total": event.registers['layouts_total'].value,
            "labels": event.registers['labels'].value,
            "labels_total": event.registers['labels_total'].value,
            "orgs": event.registers['orgs'].value,
            "orgs_total": event.registers['orgs_total'].value,
            "teams": event.registers['teams'].value,
            "teams_total": event.registers['teams_total'].value,
